...
######################## change the parameters------
   ...
   res1 <- modgrowth(
     ...
     axp = 3.5e-3 *1.2,       # [adim] Coefficient for the xylem area of composite membrane
     sigmaX = 1,         # [adim] reflection coefficient xylem
...
if(F)
{
   ...
   lines(res1$Tps[-(1:10)]/24, res1$pF[-(1:10)],type='l',col=2)
   #abline(h=c(0,0.5,1))
   abline(v=c(35,49),lty=2)
   text(20,3.3,"stage I")
   ...
   lines(res1$Tps/24,res1$el,type='l',col=2)
   abline(v=c(35,49),lty=2)
}
